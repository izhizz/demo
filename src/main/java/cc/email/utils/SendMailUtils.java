...
public class SendMailUtils {
    ...
    //发件人邮箱
    private static String myEmailAccount = "1040651714@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "tgydacoewjbfbfaa";
    /**
...
//        发送人
        ...
        msg.setFrom(new InternetAddress(myEmailAccount, "内蒙古师范大学", "UTF-8"));
