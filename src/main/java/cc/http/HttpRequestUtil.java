...
public class HttpRequestUtil {
    ...
    private static int socketTimeout = 60000;// 60 s
    private static int connectTimeout = 60000;// 60 s
    ...
    public static String post(String url, Map<String, Object> params) throws IOException {
        ...
        if (params != null && params.keySet().size() > 0) {
            ...
            while (iterator.hasNext()) {
                ...
                reqParams.add(new BasicNameValuePair(entry.getKey(), String.valueOf(entry.getValue())));
            }
        }
        httpPost.setEntity(new UrlEncodedFormEntity(reqParams, Consts.UTF_8));
        CloseableHttpResponse response = httpClient.execute(httpPost);
