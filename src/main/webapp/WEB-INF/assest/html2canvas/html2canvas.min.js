...
!function (A, e) {
    ...
    return function (A) {
        ...
        var n = e.LENGTH_TYPE = {PX: 0, PERCENTAGE: 1}, B = function () {
            function A(e) {
                !function (A, e) {
                    if (!(A instanceof e)) throw new TypeError("Cannot call a class as a function")
        ...
        var r = function () {
                ...
                return A && A.__esModule ? A : {default: A}
            }(t(0)), B = t(3), a = t(4), s = t(12), o = t(33), i = t(34), c = t(35), l = t(36), u = t(37), Q = t(38),
            w = t(8), U = t(39), g = t(40), C = t(18), d = t(17), F = t(19), f = t(11), E = t(41), h = t(20), H = t(42),
            p = t(43), N = t(44), I = t(45), K = t(2), T = t(21), m = t(14);
        var v = ["INPUT", "TEXTAREA", "SELECT"], y = function () {
            function A(e, t, r, B) {
                ...
                var S = e.ownerDocument.defaultView, L = S.pageXOffset, _ = S.pageYOffset,
                    D = S.getComputedStyle(e, null), M = (0, i.parseDisplay)(D.display),
        ...
        var r = t(4), n = e.LIST_STYLE_POSITION = {INSIDE: 0, OUTSIDE: 1}, B = e.LIST_STYLE_TYPE = {
            NONE: -1,
            DISC: 0,
            CIRCLE: 1,
            SQUARE: 2,
        ...
        var n = e.TEXT_DECORATION_STYLE = {SOLID: 0, DOUBLE: 1, DOTTED: 2, DASHED: 3, WAVY: 4},
            B = e.TEXT_DECORATION = {NONE: null},
            a = e.TEXT_DECORATION_LINE = {UNDERLINE: 1, OVERLINE: 2, LINE_THROUGH: 3, BLINK: 4}, s = function (A) {
                switch (A) {
                    case"underline":
                        return a.UNDERLINE;
                    case"overline":
        ...
        var n = e.BORDER_STYLE = {NONE: 0, SOLID: 1}, B = e.BORDER_SIDES = {TOP: 0, RIGHT: 1, BOTTOM: 2, LEFT: 3},
        ...
        e.parseBorder = function (A) {
            return a.map(function (e) {
                ...
                return {borderColor: t, borderStyle: B, borderWidth: isNaN(a) ? 0 : a}
            })
        }
    }, function (A, e, t) {
        "use strict";
        ...
        var r = l(t(9)), n = t(4), B = t(12), a = l(t(50)), s = l(t(7)), o = l(t(0)), i = l(t(1)),
            c = (t(2), t(22), t(3));
        ...
        var u = new o.default([165, 165, 165]), Q = new o.default([222, 222, 222]),
            ...
            f = [F, F, F, F], E = (e.getInputBorderRadius = function (A) {
        ...
        var s = e.TextBounds = function A(e, t) {
            ...
            for (var r = 0 !== e.style.letterSpacing ? (0, a.toCodePoints)(A).map(function (A) {
                ...
                var C = r[g];
                if (e.style.textDecoration !== n.TEXT_DECORATION.NONE || C.trim().length > 0) if (B.default.SUPPORT_RANGE_BOUNDS) w.push(new s(C, i(t, U, C.length, u, Q))); else {
        ...
        e.Proxy = function (A, e) {
            ...
            return new Promise(function (n, B) {
                ...
                if (s.onload = function () {
                        if (s instanceof XMLHttpRequest) if (200 === s.status) if ("text" === a) n(s.response); else {
        ...
        var r = function () {
            ...
            }(), n = (Q(t(16)), t(29)), B = Q(t(51)), a = Q(t(23)), s = Q(t(10)), o = t(2), i = t(54), c = t(25), l = t(0),
            u = Q(l);
            ...
            return (t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function (s) {
                return s ? function (A) {
                    return A.inlineFonts(w).then(function () {
                        ...
                        var r = new a.default(A.documentElement), n = w.defaultView, B = n.pageXOffset,
                            s = n.pageYOffset,
                            i = "HTML" === e.tagName || "BODY" === e.tagName ? (0, o.parseDocumentSize)(w) : (0, o.parseBounds)(e, B, s),
                            c = i.width, l = i.height, u = i.left, U = i.top;
                        return r.render({
                            backgroundColor: d,
                            logger: Q,
                            scale: t.scale,
                    ...
                    return d === u.container.style.background.backgroundColor && (u.container.style.background.backgroundColor = l.TRANSPARENT), i.ready().then(function (A) {
                        ...
                        var r = U.defaultView, n = r.pageXOffset, i = r.pageYOffset,
                            l = "HTML" === s.tagName || "BODY" === s.tagName ? (0, o.parseDocumentSize)(w) : (0, o.parseBounds)(s, n, i),
                            g = l.width, C = l.height, F = l.left, f = l.top, E = {
                                backgroundColor: d,
                                fontMetrics: e,
                                imageStore: A,
                                logger: Q,
        ...
        var a = function (A, e, t) {
            ...
            return r(A, [{
                key: "subdivide", value: function (e, t) {
                    var r = a(this.start, this.startControl, e), n = a(this.startControl, this.endControl, e),
                        B = a(this.endControl, this.end, e), s = a(r, n, e), o = a(n, B, e), i = a(s, o, e);
        ...
        e.parseBorderRadius = function (A) {
            return B.map(function (e) {
                var t = A.getPropertyValue("border-" + e + "-radius").split(" ").map(n.default.create), B = r(t, 2),
                    a = B[0], s = B[1];
        ...
        var o = e.LETTER_NUMBER_MODIFIER = 50, i = 10, c = 13, l = 15, u = 17, Q = 18, w = 19, U = 20, g = 21, C = 22,
            d = 24, F = 25, f = 26, E = 27, h = 28, H = 30, p = 32, N = 33, I = 34, K = 35, T = 37, m = 38, v = 39,
            y = 40, b = 42, S = (e.classes = {
                BK: 1,
                CR: 2,
                LF: 3,
                CM: 4,
                ...
                SA: b,
                XX: 43
            }, e.BREAK_MANDATORY = "!"), L = e.BREAK_NOT_ALLOWED = "×", _ = e.BREAK_ALLOWED = "÷",
            D = e.UnicodeTrie = (0, B.createTrieFromBase64)(a.default), M = [H, 36], O = [1, 2, 3, 5], R = [i, 8],
            P = [E, f], X = O.concat(R), z = [m, v, y, I, K], x = [l, c],
            V = e.codePointsToCharacterClasses = function (A) {
                ...
                if (n === i) for (var s = t; s > 0;) {
                    var o = r[--s];
                    if (Array.isArray(A) ? -1 !== A.indexOf(o) : A === o) for (var c = t; c <= r.length;) {
                        var l = r[++c];
                        if (l === e) return !0;
                        if (l !== i) break
                    }
                ...
                if (-1 !== [F, h, d, u, Q].indexOf(b)) for (var X = B; X >= 0;) {
                    var V = e[X];
                    if (V === F) return L;
                    if (-1 === [h, d].indexOf(V)) break;
                    X--
                }
                if (-1 !== [E, f].indexOf(b)) for (var G = -1 !== [u, Q].indexOf(o) ? a : B; G >= 0;) {
                    var Y = e[G];
                    if (Y === F) return L;
        ...
        e.LineBreaker = function (A, e) {
            var t = (0, s.toCodePoints)(A), r = Y(t, e), B = n(r, 3), a = B[0], o = B[1], i = B[2], c = t.length, l = 0,
                u = 0;
            return {
                next: function () {
        ...
        var c = function () {
            ...
            return n(A, [{
                ...
                key: "renderBackgroundRepeat", value: function (A, e) {
                    ...
                    if (t) {
                        var r = (0, o.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border),
                            ...
                            s = Math.round(r.left + B.x), i = Math.round(r.top + B.y);
                ...
                key: "renderStackContent", value: function (A) {
                    var e = u(A), t = r(e, 5), n = t[0], B = t[1], a = t[2], s = t[3], o = t[4], i = l(A), c = r(i, 2),
                        w = c[0], U = c[1];
        ...
        var Q = e.DocumentCloner = function () {
            ...
            }, d = ":before", F = ":after", f = "___html2canvas___pseudoelement_before",
            E = "___html2canvas___pseudoelement_after", h = function (A) {
